  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        {/* FASE: SETUP */}
        {phase === 'setup' && (
          <div key="setup" className="animate-fade-in flex flex-col items-center justify-center min-h-[70vh] gap-6">
            <div className="text-center">
              <div className="mb-3 flex justify-center">
                <span className="text-6xl">🍺</span>
              </div>
              <h2 className="text-2xl font-extrabold text-white mb-1">PULPONG</h2>
        ...
        {phase === 'teams' && tournament && (
          <div key="teams" className="animate-fade-in space-y-6">
            <div>
              <h2 className="text-xl font-bold text-white mb-0.5">Registrar equipos</h2>
              <p className="text-neutral-500 text-sm">
                {tournament.teams.length} equipo{tournament.teams.length !== 1 ? 's' : ''} registrado{tournament.teams.length !== 1 ? 's' : ''}
        ...
        {phase === 'bracket' && tournament && (
          <div key="bracket" className="animate-fade-in space-y-6">
            {tournament.champion ? (
              ...
              <>
                <div>
                  <h2 className="text-xl font-bold text-white mb-0.5">Bracket</h2>
                  <p className="text-neutral-500 text-sm">
