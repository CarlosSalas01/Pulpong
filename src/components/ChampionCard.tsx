...
export default function ChampionCard({ champion, onReset }: ChampionCardProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      <div className="bg-gradient-to-b from-amber-500/20 to-neutral-900 border-2 border-amber-500 rounded-3xl p-8 max-w-sm w-full shadow-2xl shadow-amber-900/40">
